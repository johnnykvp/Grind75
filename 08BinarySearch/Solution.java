    ...
    public int search(int[] nums, int target) {
        ...
        */
        ...
        while loop iterates through when left <= right
            int stores half distance = (right - left) / 2
            int stores mid pointer = left + half distance
        ...
        */
        ...
        half = 5 / 2 = 2 >> midIndex = 2 >> midVal = 3 < target 9
        leftIndex = 3 >> leftIndex 3 < rightIndex 5
        half = 2 / 2 = 1 >> midIndex = 4 >> midVal = 9 == target 9
        Output: 4

        Input: nums = [-1,0,3,5,9,12], target = 2
        rightIndex = 5 >> leftIndex 0 < rightIndex 5
        half = 5 / 2 = 2 >> midIndex = 2 >> midVal 3 > target 2
        rightIndex = 1 >> leftIndex 0 < rightIndex 1
        half = 1 / 2 = 0 >> midIndex = 0 >> midVal -1 < target 2
